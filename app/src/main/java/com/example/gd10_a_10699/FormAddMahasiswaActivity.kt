package com.example.gd10_a_10699
...
import com.example.gd10_a_10699.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTgl.setOnClickListener {
            val datePicker = DatePickerDialog.OnDateSetListener{ view,year,month,dayofMonth -> binding.tglView.text =
